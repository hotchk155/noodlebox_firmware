...
public:
	...
	static const int NUM_MENU_A_OPTS = 22;
	...
	const OPTION m_menu_b[NUM_MENU_B_OPTS] = {
			...
			{"CKO", P_CLOCK_OUT_MODE, PT_ENUMERATED, "OFF|ON|RUN|STAR|STOP|STST|RES|RNNG|ACC"},
			{"CKO", P_CLOCK_OUT_RATE, PT_ENUMERATED, "8|16|24PP"},
			{0},
			{"AXO", P_AUX_OUT_MODE, PT_ENUMERATED, "OFF|ON|RUN|STAR|STOP|STST|RES|RNNG|ACC"},
			{"AXO",  P_AUX_OUT_RATE, PT_ENUMERATED, "8|16|24PP"},
			{"AXI", P_AUX_IN_MODE, PT_ENUMERATED, "OFF|STST|RUN|RES|MUTX"},
			{"AXI",  P_SQL_AUX_IN_ENABLE, PT_ENUMERATED, "DSBL|ENBL"},
			{0},
			...
			{0},
			{"CAL", P_SQL_OUT_CAL, PT_ENUMERATED, "OFF|1V|2V|3V|4V|5V|6V|7V|8V"},
