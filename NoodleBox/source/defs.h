...
enum {
	...
	EV_AUX_IN				// a pulse at the AUX IN socket
...
typedef enum:byte {
	V_PULSE_OUT_MODE_NONE,
	V_PULSE_OUT_MODE_CLOCK,
	V_PULSE_OUT_MODE_GATED_CLOCK,
	V_PULSE_OUT_MODE_START,
	V_PULSE_OUT_MODE_STOP,
	V_PULSE_OUT_MODE_START_STOP,
	V_PULSE_OUT_MODE_RESTART,
	V_PULSE_OUT_MODE_RUNNING,
	V_PULSE_OUT_MODE_ACCENT,
	V_PULSE_OUT_MODE_MAX,
} V_PULSE_OUT_MODE;
