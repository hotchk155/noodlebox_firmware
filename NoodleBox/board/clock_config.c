...
- {id: OSCER_clock.outFreq, value: 19.2 MHz}
...
- {id: ICS.RDIV.scale, value: '512', locked: true}
...
- {id: SIM.DIV3.scale, value: '2'}
sources:
- {id: OSC.OSC.outFreq, value: 19.2 MHz, enabled: true}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
const osc_config_t oscConfig_BOARD_BootClockRUN =
    {
        .freq = 19200000U,                        /* Oscillator frequency: 19200000Hz */
